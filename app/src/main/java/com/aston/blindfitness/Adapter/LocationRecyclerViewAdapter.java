  ...
  public void onBindViewHolder(ViewHolder card, int position) {
    ...
    switch (selectedTheme) {
      case R.style.AppTheme:
        emojiForCircle = ResourcesCompat.getDrawable(context.getResources(), R.drawable.supportgroup, null);
        //backgroundCircle = ResourcesCompat.getDrawable(context.getResources(), R.drawable.ic_circle, null);
