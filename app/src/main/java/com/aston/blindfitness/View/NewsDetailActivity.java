...
/**
 * NewsDetailActivity to receive content from News Sources
 */
public class NewsDetailActivity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = findViewById(R.id.news_details_toolbar);
        ...
        appBarLayout = findViewById(R.id.news_details_appbar);
        ...
        date = findViewById(R.id.news_details_date);
        ...
        date.setText(NewsUtils.DateFormat(mDate));
        ...
        time.setText(mSource + author + " \u2022 " + NewsUtils.DateToTimeFormat(mDate));
        initWebView(mUrl);

    }

    /**
     * Receive and load information from web
     * @param url
     */
