...
import com.aston.blindfitness.env.ImageUtils;
import com.aston.blindfitness.env.Logger;
...
public abstract class CameraActivity extends Activity implements OnImageAvailableListener {
    ...
    private ImageView divider1, divider2;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        // Initialise views
        identifier = findViewById(R.id.object_name);
    ...
    public void onImageAvailable(final ImageReader reader) {
        // Wait until we have some size from onPreviewSizeChosen
    ...
    private void speak() {
        ...
        for (int i = 0; i < currentRecognitions.size(); i++) {
            ...
            identifier.setText(recognition.getTitle());
